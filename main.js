...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,uBAAuB;EACvB,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,SAAS;EACT,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,uCAAuC;EACvC,oCAAoC;EACpC,QAAQ;AACV;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,mBAAmB;EACnB,sBAAsB;EACtB,eAAe;AACjB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;AAClB","sourcesContent":["body {\n  font-family: sans-serif;\n  text-align: center;\n  background: #f4f6f8;\n}\n\n.boards {\n  display: flex;\n  justify-content: center;\n  gap: 50px;\n  margin-top: 20px;\n}\n\n.board {\n  display: grid;\n  grid-template-columns: repeat(10, 30px);\n  grid-template-rows: repeat(10, 30px);\n  gap: 2px;\n}\n\n.cell {\n  width: 30px;\n  height: 30px;\n  background: #e0e0e0;\n  border: 1px solid #ccc;\n  cursor: pointer;\n}\n\n.cell.ship {\n  background: #a0c4ff;\n}\n\n.cell.hit {\n  background: #ff4d4d;\n}\n\n.cell.miss {\n  background: #ccc;\n}\n"],"sourceRoot":""}]);
// Exports
  ...
  function renderBoard(board, boardId, hideShips = false) {
    ...
    for (let y = 0; y < 10; y++) {
      for (let x = 0; x < 10; x++) {
        ...
        const shipHere = board.ships.some(({
          coordinates
...
function Gameboard(size = 10) {
  ...
  function allSunk() {
    return ships.length > 0 && ships.every(({
      ship
    }) => ship.isSunk());
  }
    ...
    for (const len of fleet) {
      ...
      while (!placed && attempts < MAX_ATTEMPTS) {
        ...
        if (canPlaceShip(len, coords)) {
          placeShip((0,_ship_js__WEBPACK_IMPORTED_MODULE_0__["default"])(len), coords);
          placed = true;
        }
      }
    }
...
const player = (0,_player_js__WEBPACK_IMPORTED_MODULE_2__["default"])("You");
const computer = (0,_player_js__WEBPACK_IMPORTED_MODULE_2__["default"])("Computer", true);
const playerBoard = (0,_gameboard_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
const computerBoard = (0,_gameboard_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
// Render
_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].renderBoards(playerBoard, computerBoard);
_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].updateMessage("Your turn!");
...
document.getElementById("computer-board").addEventListener("click", e => {
  ...
  if (computerBoard.allSunk()) {
    _dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].updateMessage("🎉 You win!");
    disableBoard();
    return;
  }
  _dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].updateMessage("🤖 Computer's turn...");
...
function computerTurn() {
  ...
  if (playerBoard.allSunk()) {
    _dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].updateMessage("💀 Computer wins!");
    disableBoard();
    return;
  }
  _dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].updateMessage("Your turn!");
